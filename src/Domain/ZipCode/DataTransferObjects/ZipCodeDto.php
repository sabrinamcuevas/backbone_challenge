...
class ZipCodeDto extends Data
{
    ...
    {
        return Cache::remember('zip_codes', 10, function () use ($id) {
    ...
    {
        return Cache::remember('federal_entities', 10, function () use ($zipcode) {
    ...
    {
        return Cache::remember('settlements', 10, function () use ($zipcode) {
    ...
    {
        return Cache::remember('municipalities', 10, function () use ($settlements) {
